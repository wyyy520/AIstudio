<template>
  <Transition name="slide-in" mode="out-in">
    <div v-if="plugin" class="plugin-detail" :key="plugin.id">
      <div class="plugin-detail-header">
        ...
        <div class="plugin-detail-title-area">
          ...
          <div class="plugin-detail-meta">
            ...
            <span class="meta-sep">·</span>
            <span v-if="plugin.size" class="plugin-detail-size">{{ plugin.size }}</span>
            <span v-if="plugin.downloads" class="meta-sep">·</span>
            <span v-if="plugin.downloads" class="plugin-detail-downloads">
      ...
      <div v-if="plugin.githubUrl" class="plugin-detail-github">
        <a :href="plugin.githubUrl" target="_blank" rel="noopener noreferrer" class="github-link">
      ...
      <div class="plugin-detail-body">
        ...
        <section v-if="plugin.readme" class="detail-section">
          ...
          <div class="detail-readme" v-html="renderMarkdown(plugin.readme)"></div>
        </section>
...
.detail-readme :deep(h1),
.detail-readme :deep(h2),
.detail-readme :deep(h3) {
  color: var(--text-primary);
...
.detail-readme :deep(strong) {
  color: var(--text-primary);
  font-weight: var(--font-semibold);
}

.detail-readme :deep(em) {
  font-style: italic;
}
