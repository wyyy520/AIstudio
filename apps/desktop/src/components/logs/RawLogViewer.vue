<template>
  <div class="raw-log-viewer">
    <div class="raw-log-toolbar">
      <button class="toolbar-btn" :class="{ active: wrapEnabled }" @click="wrapEnabled = !wrapEnabled" title="切换换行">
      ...
      <button class="toolbar-btn" @click="copyAll" title="复制全部">
        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <rect width="14" height="14" x="8" y="8" rx="2" ry="2" /><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2" />
        </svg>
        复制全部
      </button>
      <button class="toolbar-btn" @click="$emit('download')" title="下载">
        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
