  ...
  <div class="error-card" :class="`severity-${analysis.severity}`">
    <div class="error-card-header">
      <div class="error-card-severity">
        ...
        <span class="severity-badge" :class="`badge-${analysis.severity}`">{{ analysis.severity }}</span>
      </div>
    ...
    <div class="error-card-body">
      ...
      <div class="error-section">
        <span class="error-label">Cause</span>
        <p class="error-text">{{ analysis.cause }}</p>
      </div>
      <div class="error-section">
        <span class="error-label">Detail</span>
        <p class="error-text error-detail">{{ analysis.detail }}</p>
      </div>
    </div>

    <div v-if="analysis.solutions.length" class="error-card-solutions">
      <span class="error-label">Solutions</span>
      <div class="solution-list">
        <div v-for="(sol, idx) in analysis.solutions" :key="sol.id" class="solution-card">
          ...
          <div v-if="sol.command" class="solution-command selectable">
            ...
            <button class="cmd-copy-btn" title="Copy" @click="copyCommand(sol.command!)">
          ...
          <div class="solution-meta">
            ...
            <span class="solution-risk" :class="`risk-${sol.risk}`">Risk: {{ sol.risk }}</span>
          </div>
