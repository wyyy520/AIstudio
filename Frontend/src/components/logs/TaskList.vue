<template>
  <div class="task-list">
    ...
    <div class="task-list-footer">
      <span class="footer-stat">{{ tasks.length }} tasks</span>
      <span class="footer-dot">·</span>
      <span class="footer-stat">{{ runningCount }} running</span>
    </div>
  </div>
</template>
...
const groups = computed(() => {
  ...
  return [
    { key: 'running', label: 'Running', tasks: list.filter(t => t.status === 'running') },
    { key: 'failed', label: 'Failed', tasks: list.filter(t => t.status === 'failed') },
    { key: 'warning', label: 'Warning', tasks: list.filter(t => t.status === 'warning') },
    { key: 'completed', label: 'Completed', tasks: list.filter(t => t.status === 'success') },
  ]
})
